...
#Selects * From Projects.title and Pledge.amount sorted by name
...
#SELECT users.name, users.age & pledges.amount for all pledges by name
...
#SELECT projects.title and amount over goal of projects that met goal
"SELECT title, SUM(pledges.amount) - SUM(funding_goal) FROM projects
